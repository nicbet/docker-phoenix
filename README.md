...
For instance, for a dockerized development environment for Phoenix 1.6.3 you could run:

```
git clone -b v1.6.3 https://github.com/nicbet/docker-phoenix ~/Projects/hello-phoenix
```
