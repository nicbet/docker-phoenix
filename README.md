...
For instance, for a dockerized development environment for Phoenix 1.4.1 you could run:
```
git clone -b 1.4.1 https://github.com/nicbet/docker-phoenix ~/Projects/hello-phoenix
```
