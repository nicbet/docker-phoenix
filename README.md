...
For instance, for a dockerized development environment for Phoenix 1.5.5 you could run:

```
git clone -b 1.5.5 https://github.com/nicbet/docker-phoenix ~/Projects/hello-phoenix
```
